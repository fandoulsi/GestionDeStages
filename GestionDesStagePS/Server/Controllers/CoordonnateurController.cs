...
namespace GestionDesStagePS.Server.Controllers
{
    ...
    public class CoordonnateurController : Controller
    {
        ...
        public CoordonnateurController(ICoordonnateurRepository coordonnateurRepository)
        {
            _coordonnateurRepository = coordonnateurRepository;
        }

        [HttpGet("{Id}")]
        public IActionResult GetCoordonnateurById(string Id)
        {
        ...
        [HttpPost]
        public IActionResult CreateCoordonnateur([FromBody] Coordonnateur coordonnateur)
        {
        ...
        [HttpPut]
        public IActionResult UpdateCoordonnateur([FromBody] Coordonnateur coordonnateur)
        {
            if (coordonnateur == null)
                return BadRequest();
